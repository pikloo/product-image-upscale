...
if (!class_exists('ProductAttachment')) {
    class ProductAttachment
    {
        ...
        public static function iu_get_attachment_width($attachment_id, $size = 'full'): int | null
        {
            ...
            return $attachment_attributes ? $attachment_attributes[1] : null ;
        }
        ...
        {
            $attachment_attributes =  wp_get_attachment_image_src($attachment_id, $size);
            return $attachment_attributes ? $attachment_attributes[2] : null ;
        }
         ...
         * @param array $original_attachment_meta
         * @param string|int $new_attachment_id
         * @return void
         */
